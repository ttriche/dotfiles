...
## paths 
export PATH=$HOME/bin:$HOME/Dropbox/Julia/julia-1.3.1/bin:$HOME/igv/default:$HOME/.local/bin:$PATH
...
# I hate local resolver fuckery
alias fixresolv="sudo cp /etc/resolv.conf.fixed /etc/resolv.conf"
...
#__conda_setup="$(CONDA_REPORT_ERRORS=false '/home/tim/miniconda2/bin/conda' shell.bash hook 2> /dev/null)"
#if [ $? -eq 0 ]; then
#    \eval "$__conda_setup"
#else
#    if [ -f "/home/tim/miniconda2/etc/profile.d/conda.sh" ]; then
#        . "/home/tim/miniconda2/etc/profile.d/conda.sh"
